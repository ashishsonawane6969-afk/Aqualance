...
(function () {
  ...
  function renderVariants(variants){
    ...
    /* Base chip — only shown if no variants OR product has no variants */
  ...
  /* Update dist chip price+visibility when variant changes */
  ...
  function renderProduct(p){
    ...
    if(atc){  atc.addEventListener('click', addToCart);
