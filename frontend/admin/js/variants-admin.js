/* ═══════════════════════════════════════════════════════════════
   ...
   Load AFTER admin.js on the products admin page.
   ═══════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  window.addVariantRow = function (v) {
    ...
    row.innerHTML =
      ...
      + '<input type="text" class="va-name" placeholder="e.g. 75g, 100ml, 4 Pack"'
      ...
      + '<div class="va-cell">'
      + '<label>SKU</label>'
      + '<input type="text" class="va-sku" placeholder="Optional"'
