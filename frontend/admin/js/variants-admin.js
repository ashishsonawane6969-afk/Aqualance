...
(function () {
  ...
  window.addVariantRow = function (v) {
    ...
    var mainHtml =
      ...
      +   '<input type="text" class="va-name" placeholder="e.g. 100 GM, 500 ML, 4 Pack"'
    ...
    var bundleToggleHtml =
      ...
      + '<input type="checkbox" class="va-bundle-cb"' + (isBundleEnabled ? ' checked' : '') + '>'
    ...
    var bundleFieldsHtml =
      ...
      +     '<input type="number" class="va-bq" placeholder="100" min="0.01" step="0.01"'
      +     ' value="' + (v.base_quantity != null ? _esc(String(v.base_quantity)) : '') + '">'
      +   '</div>'
      +   '<div class="va-cell">'
      +     '<label>Unit</label>'
      +     '<select class="va-bu">' + unitOpts + '</select>'
      +   '</div>'
      +   '<div class="va-cell">'
      +     '<label>Pack Size</label>'
      +     '<input type="number" class="va-bp" placeholder="3" min="1" step="1"'
      +     ' value="' + (v.pack_size != null ? _esc(String(v.pack_size)) : '') + '">'
      +   '</div>'
      +   '<div class="va-cell">'
      +     '<label>Display Name <span style="font-weight:400;letter-spacing:0;font-size:.6rem">(auto)</span></label>'
      +     '<input type="text" class="va-dn" placeholder="Auto-generated"'
